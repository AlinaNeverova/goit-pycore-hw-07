"""
Extend contact management system.Adds Birthday support to the Record class with date validation. 
Includes birthday parsing, storage, and upcoming birthday tracking.
"""
...
class Phone(Field):
    ...
    def validate(self, value):                          # Валідація номеру телефону на 10 символів мінімум
...
class Birthday(Field):
    def __init__(self, value):
        try:
            parsed_date = datetime.strptime(value, "%d.%m.%Y")   # Валідація формату дати
...
class Record:
    ...
    def __str__(self):                                   # У відображення адресної книги вкладаємо одразу ім'я, список номерів та день народження
